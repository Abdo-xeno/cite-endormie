...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* LA SCÈNE — la cité endormie, en profondeur */}
      <motion.div
      ...
      >
        ...
        <motion.p
          ...
          className="mx-auto mt-8 max-w-xl font-display text-lg italic leading-relaxed text-cream/70 md:text-xl"
        >
          Une cité dort. Un homme en profite.
          <br />
          Un seul s'éveille — et il vous appelle.
        </motion.p>
