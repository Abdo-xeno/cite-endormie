...
/**
 * Épilogue (v2) — la VRAIE fin, en un seul mouvement : le Sage tempère le
 * triomphe (« ceci n'est que le début »), lance le cliffhanger (« réveillerez-
 * vous le monde ? »), puis le dua de clôture scelle l'ensemble. Plus de fausse
 * fin : le dua ne vit qu'ici, en dernier.
 */
export default function EpilogueSageV2() {
  const { team } = useTeam();
  ...
  return (
    <section className="relative overflow-hidden px-6 py-36">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        {/* Le dua de clôture — sceau humble, en tout dernier */}
        <Reveal delay={0.75}>
          <div className="mx-auto mt-16 max-w-md border-t border-sacred/15 pt-10">
            ...
            <p className="mt-8 text-xs uppercase tracking-[0.3em] text-cream/30">
